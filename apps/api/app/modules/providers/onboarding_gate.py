...
def build_provider_onboarding_gate(
    ...
    Phase 14 preserves this behavior and ignores checklist and secret-readiness inputs because
...
def refuse_provider_activation(
    ...
    This function does not contain conditional activation logic in Phase 14.
    """
