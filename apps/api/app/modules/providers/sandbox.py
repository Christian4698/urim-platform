...
def build_sandbox_provider_status_response() -> SandboxProviderStatusResponse:
    ...
    return SandboxProviderStatusResponse(
        ...
        safeguards=[
            ...
            "Provider onboarding gate blocks real provider activation in Phase 13.",
            "Rate-limit, quota, reconciliation, secret safety and preflight contracts are readiness-only in Phase 13.",
