...
def build_sandbox_provider_status_response() -> SandboxProviderStatusResponse:
    ...
    return SandboxProviderStatusResponse(
        ...
        safeguards=[
            ...
            "Provider onboarding gate blocks real provider activation in Phase 14.",
            "Rate-limit, quota, reconciliation, secret safety, preflight and real-provider shell contracts are readiness-only in Phase 14.",
