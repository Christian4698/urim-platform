...
SECRET_TOKENS = (
    ...
    "DEMO_NON_PROD_FAKE_PHASE13_API_KEY",
    "DEMO_NON_PROD_FAKE_PHASE13_API_SECRET",
    "DEMO_NON_PROD_FAKE_PHASE13_WEBHOOK_SECRET",
    "DEMO_NON_PROD_FAKE_PHASE13_CLIENT_ID",
    "DEMO_NON_PROD_FAKE_PHASE13_CLIENT_SECRET",
)


@pytest.mark.parametrize("path", PUBLIC_GET_ENDPOINTS)
def test_public_get_endpoints_include_phase_thirteen_security_headers(path: str) -> None:
