...
from app.core.security import SECURITY_HEADERS, phase_thirteen_security_assertions
...
def test_health_endpoint() -> None:
    ...
    assert response.json() == {
        ...
        "app_name": "URIM",
        "engine_name": "Kairos",
        "phase": "phase-13-provider-preflight-safety-review",
    }
...
def test_version_endpoint_exposes_phase_thirteen_safety_overrides() -> None:
...
def test_readiness_endpoint_has_no_required_real_dependencies() -> None:
    ...
    assert payload["phase"] == "phase-13-provider-preflight-safety-review"
...
def test_phase_thirteen_security_assertions() -> None:
    assert phase_thirteen_security_assertions() == {
