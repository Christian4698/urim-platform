...
from app.core.security import SECURITY_HEADERS, phase_twelve_security_assertions
...
def test_health_endpoint() -> None:
    ...
    assert response.json() == {
        ...
        "app_name": "URIM",
        "engine_name": "Kairos",
        "phase": "phase-12-provider-env-secret-safety",
    }
...
def test_version_endpoint_exposes_phase_twelve_safety_overrides() -> None:
...
def test_readiness_endpoint_has_no_required_real_dependencies() -> None:
    ...
    assert payload["phase"] == "phase-12-provider-env-secret-safety"
...
def test_phase_twelve_security_assertions() -> None:
    assert phase_twelve_security_assertions() == {
